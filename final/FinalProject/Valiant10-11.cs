public class Valiant1011 : ClassDescription
{
    ...
    public override void Progress()
    {
        ...
        Console.WriteLine(" 3. stay reverent during class- 3pts");
        Console.WriteLine(" 4. offer prayer in class - 4pts");
        Console.WriteLine(" 5. read a scripture during class - 5pt");
        Console.WriteLine(" 6. Attend weekly activty");
        Console.WriteLine(" 7. Participate in weekly activity");
        ...
        else if (studentProgress == "6")
        {
            _progress = "6";
        }
        else if (studentProgress == "7")
        {
            _progress = "7";
        }
